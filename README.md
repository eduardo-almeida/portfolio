...
* [**MBA Ciência de Dados:**](https://github.com/eduardo-almeida/portfolio/tree/main/MBA%20Data%20Science%20-%20UNIFOR) Formação em Data Science feito na UNIfor de Abril de 2024 até os dias atuais. Previsão de termino março de 2026.
...
* [**Estudo de Segurança Pública:**](https://github.com/eduardo-almeida/portfolio/tree/main/Seguranca%20P%C3%BAblica) Realização de um estudo de caso para fins de verificação de quais ruas e bairros onde mais ocorrem roubos, utilizando  dados disponibilizados pela Secretaria de Segurança de São Paulo. Utilização do modelo Arima para prever a quantidade de novos casos.
